...
const dummyMentorData = {
  ...
  user: {
    ...
    bio: "Principal Software Engineer with 12+ years of experience in full-stack development, scalable system design, and cloud-native applications.",
  },
  sessions: [
    {
      sessionId: 201,
      sessionStartTime: "2025-04-15T14:00:00",
      sessionEndTime: "2025-04-15T15:00:00",
      sessionType: "ONE_ON_ONE",
      sessionFee: 1500.0, // INR (Indian Rupees)
      mentorId: 101,
      applicantId: 301,
      sessionLink: "meet.google.com/xyz-abc-123",
      status: "pending",
    },
    {
      sessionId: 202,
      sessionStartTime: "2025-04-16T16:00:00",
      sessionEndTime: "2025-04-16T17:00:00",
      sessionType: "ONE_ON_ONE",
      sessionFee: 1500.0, // INR
      mentorId: 101,
      applicantId: 302,
      sessionLink: "meet.google.com/uvw-rst-456",
      status: "accepted",
    },
  ],
  ratings: [
    {
      ...
      rating: 5,
      comment:
        "Rajesh Sir explained system design concepts very clearly. Highly recommend!",
      date: "2025-04-10",
    },
    {
      id: 2,
      rating: 4,
      comment:
        "Great insights on React performance optimization and backend scaling!",
      date: "2025-04-08",
    },
  ],
};
                    ...
                    <div className="space-y-3">
                      ...
                      <div className="space-y-2 text-gray-300">
                        <div className="flex items-center space-x-2">
                          ...
                          <span>
                            {formatDateTime(session.sessionStartTime)}
                          </span>
                        </div>
                        <div className="flex items-center space-x-2">
